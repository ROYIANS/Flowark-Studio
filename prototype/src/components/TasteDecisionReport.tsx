...
const DataMirrorView = () => (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
        <div className="mb-16">
            <h2 className="text-2xl font-serif text-[#2D2A26] mb-8">
                《断舍离那篇》vs 你的常规表现
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12">
                {[
                    ...
                    <div key={metric.label} className="border-b border-[#EBE5E0] pb-6">
                        <div className="text-sm text-[#8E8780] mb-3 uppercase tracking-wider font-bold">{metric.label}</div>
                        <div className="flex items-baseline gap-4">
                            <div className="text-4xl font-serif text-[#2D2A26]">{metric.value}</div>
                            <div className="text-sm text-[#8E8780] font-light">
                                (平均: {metric.avg})
                            </div>
                            {metric.trend === 'up' && (
        ...
        {/* 互动热点 */}
        <div className="pt-12 border-t border-[#EBE5E0]">
            <h3 className="text-xl font-medium text-[#2D2A26] mb-8">互动热点分布</h3>
            <div className="space-y-8">
                {[
                    ...
                    <div key={index} className="pl-6 border-l border-[#E86435]">
                        <div className="text-[#2D2A26] mb-3 font-light text-lg italic">"{item.section}"</div>
                        <div className="flex gap-6">
                            {item.reactions.map((reaction, idx) => (
                                <div key={idx} className="flex items-center gap-2 text-[#8E8780] text-sm">
                                    {reaction.icon}
...
const DecisionReviewView = () => (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 space-y-16">
        ...
        <div>
            ...
            <p className="text-2xl text-[#2D2A26] font-serif leading-relaxed italic">
        ...
        {/* 决策链条 */}
        <div className="pt-12 border-t border-[#EBE5E0]">
            <h3 className="text-xl font-medium text-[#2D2A26] mb-12">你的创作决策 → 内容呈现 → 读者反馈</h3>

            <div className="space-y-12">
                {/* 决策1 */}
                <div className="relative pl-8 border-l border-[#EBE5E0]">
                    <div className="absolute -left-[5px] top-0 w-2 h-2 rounded-full bg-[#E86435]"></div>
                    <div className="mb-4">
                        <span className="text-xs font-bold tracking-widest uppercase text-[#E86435]">
                            创作中，你选择了
                        </span>
                    </div>
                    <ul className="space-y-3 text-[#2D2A26] mb-4">
                        <li className="flex items-start gap-3">
                            <span className="text-[#E86435]">•</span>
                            <span className="font-light text-lg">开头方式: <strong>痛点共鸣式</strong> (而非场景描述)</span>
                        </li>
                        <li className="flex items-start gap-3">
                            <span className="text-[#E86435]">•</span>
                            <span className="font-light text-lg">关键转折: 在第3段插入了<strong>个人故事</strong></span>
                        </li>
                        <li className="flex items-start gap-3">
                            <span className="text-[#E86435]">•</span>
                            <span className="font-light text-lg">结尾方式: <strong>留白式提问</strong> (而非行动号召)</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="relative pl-8 border-l border-[#EBE5E0]">
                    ...
                    <div className="mb-4">
                        <p className="text-[#2D2A26] font-light leading-relaxed mb-4 text-lg">
                ...
                <div className="relative pl-8">
                    ...
                    <div className="pl-6 py-2">
                        <p className="text-[#2D2A26] font-light leading-relaxed mb-3 text-lg">
...
const GrowthArchiveView = () => (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
        <div className="mb-12">
            ...
            <p className="text-[#8E8780] text-sm mb-12">基于 8 篇创作 · 47 个品味印记</p>

            {/* 强化风格 */}
            <div className="mb-12 pb-12 border-b border-[#EBE5E0]">
                <h3 className="text-lg font-medium text-[#2D2A26] mb-6">你在持续强化的风格</h3>
                <ul className="space-y-6">
                    <li className="flex items-start gap-4">
                        <span className="text-[#E86435] text-xl">•</span>
                        <div>
                            <p className="text-[#2D2A26] font-light text-lg">
                                <strong>"开头用痛点共鸣"</strong>
                            </p>
                            <p className="text-[#8E8780] text-sm mt-1">用了6次，平均完读率比其他方式高15%</p>
                        </div>
                    </li>
                    <li className="flex items-start gap-4">
                        <span className="text-[#E86435] text-xl">•</span>
                        <div>
                            ...
                            <p className="text-[#8E8780] text-sm mt-1">持续高互动，建议作为你的内容标签</p>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            {/* 探索新方向 */}
            <div className="mb-12 pb-12 border-b border-[#EBE5E0]">
                <h3 className="text-lg font-medium text-[#2D2A26] mb-6">你在探索的新方向</h3>
            ...
            {/* 品味图谱变化 */}
            <div className="mb-12 pb-12 border-b border-[#EBE5E0]">
                <h3 className="text-lg font-medium text-[#2D2A26] mb-6">品味图谱变化</h3>
            ...
            {/* 解锁成就 */}
            <div className="mb-12">
                <h3 className="text-lg font-medium text-[#2D2A26] mb-6">解锁成就</h3>
                <div className="flex items-start gap-4">
                    <div className="text-4xl">🏅</div>
                    <div>
                        <h4 className="font-bold text-[#E86435] mb-1 text-lg">"节奏大师"</h4>
            ...
            {/* 月度总结 */}
            <div className="mt-16 pt-12 border-t border-[#EBE5E0]">
                <label className="text-lg text-[#2D2A26] font-medium mb-4 block">
                    要给这个月写一句总结吗？
                </label>
                <p className="text-xs text-[#8E8780] mb-6">(这句话会出现在你的"品味时间轴"上)</p>
                <input
                    type="text"
                    placeholder="比如：这个月找到了自己的叙事节奏..."
                    className="w-full py-4 border-b border-[#EBE5E0] text-[#2D2A26] focus:outline-none focus:border-[#E86435] transition-colors bg-transparent text-xl font-serif placeholder-[#EBE5E0]"
                />
                <div className="mt-8">
                    <Button variant="primary">
                        保存到时间轴
